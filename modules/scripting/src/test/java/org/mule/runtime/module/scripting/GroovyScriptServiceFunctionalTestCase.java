...
public class GroovyScriptServiceFunctionalTestCase extends FunctionalTestCase {
  ...
  public void testInlineScript() throws Exception {
    ...
    flowRunner("inlineScript").withPayload("Important Message").dispatch();
  ...
  public void testFileBasedScript() throws Exception {
    MuleClient client = muleContext.getClient();
    flowRunner("fileBasedScript").withPayload("Important Message").dispatch();
  ...
  public void testReferencedScript() throws Exception {
    MuleClient client = muleContext.getClient();
    flowRunner("referencedScript").withPayload("Important Message").dispatch();
  ...
  public void testScriptVariables() throws Exception {
    MuleClient client = muleContext.getClient();
    flowRunner("scriptVariables").withPayload("Important Message").dispatch();
